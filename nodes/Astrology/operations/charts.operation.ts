...
const customActivePointsField: INodeProperties = {
	...
	default: ['Sun', 'Moon', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Ascendant', 'Medium_Coeli'],
...
const enableFixedStarsField: INodeProperties = {
	...
	default: false,
	description: 'Whether to include fixed star positions and aspects in the chart',
};
...
const includeParansField: INodeProperties = {
	...
	default: false,
	description: 'Whether to include paran calculations (stars co-rising, co-culminating, co-setting)',
};
